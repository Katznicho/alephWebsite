...
<head>
    ...
    <!-- Your page title -->
    <title>Clean water and food in Syria | Causes | Faith in Christ Church</title>
                ...
                <div class="promotion">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="flex-md-6 flex-lg-3">
                            <a href="https://www.templatemonster.com/website-templates/faith-in-christ-church-christian-church-website-template-118518.html?_gl=1*1n6aq9e*_ga*MTQwODAzODI5OS4xNjE3NDkzMTkz*_ga_FTPYEGT5LY*MTYyNDE0NjEwMy43NS4xLjE2MjQxNDYxMDUuNTg.&_ga=2.233450718.1907862184.1623810204-1408038299.1617493193" class="button button--promotion button-block-sm">Get full version</a>
                        </div><!-- .flex-* -->
                    </div>
            ...
            <div class="container">
                ...
                <div class="header__nav">
                    ...
                    <ul class="header__navitems show-on-lg" id="mobile-menu">
                        ...
                        <li class="header__list"><a href="index.html">Home</a></li><!-- .header__list ends -->
                        ...
                        <li class="header__list active">
                            ...
                            <div class="header__submenu">
                                <ul>
                                    ...
                                    <li class="header__list active"><a href="causes-single.html">Causes single</a></li>
            ...
            <div class="container">
                ...
                <div class="donors pad-b-sm-4">
                    ...
                    <div class="donors-pictures display-flex">
                        ...
                        <div class="donor">
                            <div class="avatar avatar--medium">
                                <img src="images/avatar-9.png" alt="">
                            </div>
                        </div><!-- .donor ends -->

                        <div class="donor">
                            <div class="avatar avatar--medium">
                                <img src="images/avatar-8.png" alt="">
                            </div>
                        </div><!-- .donor ends -->
            ...
            <div class="single-page__share background-off-white pad-t-sm-2 pad-b-sm-2">
                ...
                <div class="container">
                    ...
                    <div class="display-flex align-items-center">
                        ...
                        <div class="social">
                            <a href="" class="transparent button button--primary button--outline share-button"><i class="ri-facebook-line"></i></a>
                        </div><!-- .social ends -->

                        <div class="social">
                            <a href="" class="transparent button button--primary button--outline share-button"><i class="ri-linkedin-line"></i></a>
                        </div><!-- .social ends -->

                        <div class="social">
                            <a href="" class="transparent button button--primary button--outline share-button"><i class="ri-twitter-line"></i></a>
                        </div><!-- .social ends -->

                        <div class="social">
                            <a href="" class="transparent button button--primary button--outline share-button"><i class="ri-instagram-line"></i></a>
                        </div><!-- .social ends -->
                            ...
                            <div class="donations__amount mar-b-sm-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="flex-sm-12 flex-lg-4 flex-md-6 mar-t-sm-2 mar-t-lg-0">
                                        ...
                                        <div class="form__group">
                                            <label for="custom" class="form__label form__label--custom"><span><i class="ri-money-dollar-circle-line"></i></span></label>
                                            <input type="text" name="donation-amount" class="form__input custom-amount" id="custom" placeholder="Enter a custom amount">
                                        </div><!-- .form__group ends -->
                        ...
                        <div class="card cause">
                            ...
                            <div class="card__footer">
                                ...
                                <div class="card__share text-right-sm">
                                    <button class="transparent button button--primary button--outline share-button"><i class="ri-share-line"></i></button>
            ...
            <div class="time-location">
                ...
                <div class="time-location__content">
                    ...
                    <div class="time-location__map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2934.500392314035!2d-73.76198333429348!3d42.650750424686215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89de0a3cdc54f8b3%3A0x369f717b85d43cfc!2sMadison%20Ave%20%26%20Empire%20State%20Plaza!5e0!3m2!1sen!2sus!4v1583133727681!5m2!1sen!2sus"></iframe>
