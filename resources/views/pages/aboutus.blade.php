            ...
            <div class="container">
                ...
                <div class="banner__content">
                    ...
                    <div class="breadcrumb">
                        <div class="breadcrumb__home--link"><a href="{{route('welcome')}}">Home</a></div>
                        <span>/</span>
                    ...
                    <div class="row align-items-center default-section-spacing pad-b-sm-0 mar-b-lg-4">
                        ...
                        <div class="flex-lg-6">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi ipsum quae,
                                ...
                                aliquam reiciendis culpa. Fugiat quia iusto provident doloremque! Incidunt, magnam.
                                Itaque voluptatem
                                utiure temporibus harum dolorem totam quidem iste animi similique eum repellendus
                                aspernatur
                                perspiciatis doloribus incidunt nemo ratione voluptate veniam sequi tenetur, non
                                exercitationem quo
                                quam.
                                Blanditiis</p>
                        ...
                        <div class="flex-lg-6">
                            ...
                            <div class="image-box mar-t-sm-8 mar-t-lg-0 mar-b-sm-8 mar-b-lg-0">
                                ...
                                <div class="box box--center">
                                    <img src="images/standing-girl.jpg" alt="">
                                </div><!-- .box ends -->

                                <div class="box box--top-right">
                                    <img src="images/happy-kid.jpg" alt="">
                                </div><!-- .box ends -->

                                <div class="box box--bottom-right">
                                    <img src="images/singing-girl.jpg" alt="">
                                </div><!-- .box ends -->

                                <div class="box box--top-left">
                                    <img src="images/church-bldg-sm.jpg" alt="">
                                </div><!-- .box ends -->

                                <div class="box box--bottom-left">
                                    <img src="images/bible-sm.jpg" alt="">
                                </div><!-- .box ends -->
                    ...
                    <div class="row">
                        ...
                        <div class="flex-md-6">
                            ...
                            <div class="mission-vision__box mission">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam, repellat? Inventore
                                    totam
                                    repudiandae architecto sint, est aspernatur quis dolore consequuntur, explicabo
                                    nobis illum facere,
                                    voluptatum odio in cupiditate rem culpa.</p>
                                <p>Iusto, eveniet quibusdam totam doloribus aperiam, nam placeat amet tempore nesciunt
                                    magni sed ut
                                    asperiores? Cupiditate, explicabo atque rem quos mollitia repellat quod perferendis
                                    amet ipsum nam
                                    voluptatum, ut maiores?</p>
                                <p>Dolores dolor itaque placeat eos harum minus iste sapiente ullam. Impedit vitae nulla
                                    exercitationem sapiente placeat nesciunt tempora ullam asperiores itaque pariatur
                                    dolorem ipsa
                ...
                <div id="our-leaders-carousel" class="our-leaders__carousel owl-carousel">
                    ...
                    <div class="card staff">
                        ...
                        <div class="card__header no-overlay">
                            ...
                            <img src="images/user-3.jpg" alt="" class="card__image">
                    ...
                    <div class="card staff">
                        ...
                        <div class="card__header no-overlay">
                            ...
                            <img src="images/user-1.jpg" alt="" class="card__image">
                    ...
                    <div class="flex-md-6 flex-lg-3">
                        ...
                        <div class="card stats">
                            ...
                            <div class="card__header">
                                ...
                                <img src="images/gallery-3@1.5x.jpg" alt="" class="card__image">
                    ...
                    <div class="flex-md-12 flex-lg-6 order">
                        ...
                        <div class="card stats custom-height">
                            ...
                            <div class="card__header">
                                ...
                                <img src="images/student-standing.jpg" alt="" class="card__image">
